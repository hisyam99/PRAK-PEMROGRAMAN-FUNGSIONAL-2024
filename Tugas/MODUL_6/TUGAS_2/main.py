...
def watermark_gambar(image_array, watermark_path):
    ...
    watermark_width = int(image.size[0] * 0.2)  # ukuran watermark 20% dari lebar gambar
    ...
    # Pindahkan watermark ke ujung kanan gambar
    pos = (image.size[0] - watermark.size[0], image.size[1] - watermark.size[1])
